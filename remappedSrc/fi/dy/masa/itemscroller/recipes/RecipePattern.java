...
public class RecipePattern extends AbstractRecipePattern
{
    ...
    public <T extends RecipeInput> Recipe<T> lookupVanillaRecipe(World world) {
        ...
        for (RecipeEntry<CraftingRecipe> match : mc.world.getRecipeManager().getAllMatches(net.minecraft.recipe.RecipeType.CRAFTING, CraftingRecipeInput.create(recipeSize, recipeSize, Arrays.asList(recipe)), world))
        {
